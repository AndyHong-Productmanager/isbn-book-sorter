...
public final class CsvExporterTest {
    ...
    public void exportBooksEscapesRfc4180UnicodeAndFormulaCells() {
        ...
        assertEquals(
                "ISBN,Title,Authors,Publisher,Published Date,Category,Source,Description,Page Count,Thumbnail URL,Saved At\r\n"
                        + "9788998139766,\"수식, \"\"인용\"\"\n줄\",'=홍길동,'+출판사,2024-01-03,'-분류,'@source,\"설명\r\n다음 줄\",321,\"https://example.com/a,b.jpg\",1700000000000\r\n",
                csv);
    }
